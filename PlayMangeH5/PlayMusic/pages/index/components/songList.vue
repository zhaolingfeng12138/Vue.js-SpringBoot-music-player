<template>
	<scroll-view scroll-x class="music-list-wrapper" scroll-with-animation :show-scrollbar=false>
		<view class="list-item" v-for="item in currentList" :key="item.id">
			...
			<view class="bg-img flex align-end list-item-image"
				:style="'background-image:url(' + (item.pic || item.coverImgUrl) + '?param=230y230)'"
